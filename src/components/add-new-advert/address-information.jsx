...
import countriesDataJson from "../../components/add-new-advert/countries.json"

const AddressInformationSection = ({ cities, districts, state }) => {
  ...
  useEffect(() => {
    ...
    const handleSelectCountry = (e) => {
        ...
        let countryName = countriesDataJson.filter((item) => item?.id == e.target.value);
